...
public class Board {
    ...
    private static void initializeIntersections(){
        //3 way
        intersections[8][14] = new Intersection(new Point(8, 14), 270, Arrays.asList("F", "R"));
        intersections[7][17] = new Intersection(new Point(7, 17), 90, Arrays.asList("F", "L"));
        intersections[9][16] = new Intersection(new Point(9, 16), 180, Arrays.asList("R", "L"));

        // 3 way
        intersections[22][8] = new Intersection(new Point(22, 8), 0, Arrays.asList("F", "L"));
        intersections[23][10] = new Intersection(new Point(23, 10), 90, Arrays.asList("R", "L"));
        intersections[25][9] = new Intersection(new Point(25, 9), 180, Arrays.asList("F", "R"));

        //4 way
        intersections[6][4] = new Intersection(new Point(6, 4), 0, Arrays.asList("F", "R", "L"));
        intersections[7][6] = new Intersection(new Point(7, 6), 90, Arrays.asList("F", "R", "L"));
        intersections[8][3] = new Intersection(new Point(8, 3), 270, Arrays.asList("F", "R", "L"));
        intersections[9][5] = new Intersection(new Point(9, 5), 180, Arrays.asList("F", "R", "L"));

        //4 way
        intersections[6][23] = new Intersection(new Point(6, 23), 0, Arrays.asList("F", "R", "L"));
        intersections[7][25] = new Intersection(new Point(7, 25), 90, Arrays.asList("F", "R", "L"));
        intersections[8][22] = new Intersection(new Point(8, 22), 270, Arrays.asList("F", "R", "L"));
        intersections[9][24] = new Intersection(new Point(9, 24), 180, Arrays.asList("F", "R", "L"));

        //4 way
        intersections[22][23] = new Intersection(new Point(22, 23), 0, Arrays.asList("F", "R", "L"));
        intersections[23][25] = new Intersection(new Point(23, 25), 90, Arrays.asList("F", "R", "L"));
        intersections[24][22] = new Intersection(new Point(24, 22), 270, Arrays.asList("F", "R", "L"));
        intersections[25][24] = new Intersection(new Point(25, 24), 180, Arrays.asList("F", "R", "L"));
    }
    ...
    public static boolean isEmpty(Point point){
        return objects[point.x][point.y] == null;
    }
